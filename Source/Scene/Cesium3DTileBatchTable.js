...
// TODO: Same TODOs below in getFragmentShaderCallback
    ...
    function replaceDiffuse(source, colorBlendMode, diffuseUniformName) {
        ...
        if (type === 'vec3') {
            ...
            diffuseMix =       '    vec4 diffuse = (tile_featureColor.rgb == vec3(1.0)) ? vec4(' + diffuseUniformName + ', 1.0) : mix(vec4(' + diffuseUniformName + ', 1.0), tile_featureColor, 0.5); \n';
            ...
            diffuseMix =       '    vec4 diffuse = (tile_featureColor.rgb == vec3(1.0)) ? ' + diffuseUniformName + ' : mix(' + diffuseUniformName + ', tile_featureColor, 0.5); \n';
            regex = new RegExp(diffuseUniformName, 'g');
